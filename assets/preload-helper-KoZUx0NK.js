...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){let r=new Float32Array(oo),i=new J(0,1,0);return new Xi({name:`SphericalGaussianBlur`,defines:{n:oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(){return new Xi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new Xi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wo(),fragmentShader:`
	...
	`}var To=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      void main() {
        ...
        float hover = uPointerActive * (1.0 - smoothstep(0.035, ${hl.toFixed(2)}, distanceToPointer));
    ...
    `}),_=new wi(m,g);i.add(_);let v=1,y=1,b=1,x=72,S=!1,C=[],w=[h.uCatPositionA,h.uCatPositionB],T=[h.uCatHalfSizeA,h.uCatHalfSizeB],E=[h.uCatPresenceA,h.uCatPresenceB],D=()=>{if(!r)return[];let t=e.getBoundingClientRect();return(e.classList.contains(`hero-particles`)?[`.landing-topbar`,`.hero-lockup`,`.hero-kicker`,`#landing-title`,`.hero-body`,`.scroll-cue`,`.landing-progress`]:[`.landing-topbar`,`.verification-overview`,`.dropzone-copy`]).flatMap(e=>Array.from(document.querySelectorAll(e)).flatMap(e=>{let n=e.getBoundingClientRect();return n.width<=0||n.height<=0?[]:[{left:n.left-t.left,top:n.top-t.top,right:n.right-t.left,bottom:n.bottom-t.top}]}))},O=(e,t=!1)=>{let n=C[e];if(!n)return;if(x=jl(v,y),t){let e=n.hasPlaced?[n.positionNdc]:[];n.positionNdc=Il(v,y,x,p,e,D()),n.tiltDegrees=Ml(p),n.expression=El(p),n.points.geometry=n.geometries[n.expression],n.hasPlaced=!0}let r=x*2/y;n.points.scale.set(r,r,1),n.points.position.x=n.positionNdc[0]*b,n.points.position.y=n.positionNdc[1],n.points.rotation.z=wt.degToRad(n.tiltDegrees),w[e].value.set(...n.positionNdc),T[e].value.set(x/v*.46,x/y*.46)};t.revealCats&&Rl().then(e=>{if(S){Object.values(e).forEach(e=>e.dispose());return}for(let t=0;t<1;t+=1){let n={value:.24},r={value:0},a=new Xi({uniforms:{uPixelRatio:{value:s},uAmbientOpacity:n,uExcitation:r,uPresence:{value:0}},vertexColors:!0,transparent:!0,depthTest:!1,depthWrite:!1,blending:1,toneMapped:!1,vertexShader:`
            uniform float uPixelRatio;
          ...
          `}),o=new wi(e.smile,a);o.position.z=.45,o.renderOrder=2,i.add(o),C.push({points:o,material:a,ambientOpacity:n,excitation:r,positionNdc:t===0?[-.68,.3]:[.68,.14],tiltDegrees:0,appearanceStartedAt:performance.now()/1e3,hasPlaced:!1,hasResetTimer:!1,holdSeconds:8,missedAppearances:0,wasDiscovered:!1,renderedExcitation:0,expression:`smile`,geometries:e}),O(t,!0)}}).catch(()=>{});let k=()=>{let t=e.getBoundingClientRect(),n=Math.max(1,Math.round(t.width)),r=Math.max(1,Math.round(t.height)),i=n/r;v=n,y=r,b=i,h.uViewportAspect.value=i,a.left=-i,a.right=i,a.top=1,a.bottom=-1,a.updateProjectionMatrix(),_.scale.x=i/1.35,o.setSize(n,r,!1),C.forEach((e,t)=>O(t))},A=new ResizeObserver(k);A.observe(e),k();let j=!0,ee=0,M=0,N=0,P=t=>{if(!j)return;let s=t/1e3,c=M>0?Math.min(.1,s-M):1/60;M=s,h.uTime.value=n?0:s,r&&s>=N&&(h.uPointerActive.value=0),C.forEach((t,r)=>{let i=Math.max(0,s-t.appearanceStartedAt);!n&&i>=wl(t.holdSeconds)&&(t.missedAppearances=kl(t.missedAppearances,t.wasDiscovered),O(r,!0),t.appearanceStartedAt=s,t.hasResetTimer=!1,t.holdSeconds=8,t.wasDiscovered=!1,i=0);let a=Fl([h.uPointer.value.x,h.uPointer.value.y],t.positionNdc,b),o=h.uPointerActive.value*(1-wt.smoothstep(a,hl*.28,hl)),l=i<Cl(t.holdSeconds)?o:0;l>.02&&(t.wasDiscovered=!0,t.missedAppearances=0),!n&&Pl(i,t.hasResetTimer,l,t.holdSeconds)&&(t.holdSeconds=Tl(p),t.appearanceStartedAt=s-1,t.hasResetTimer=!0,i=1);let u=Al(i,n,t.holdSeconds),d=e.getBoundingClientRect().top,f=e.classList.contains(`hero-particles`)?wt.clamp(-d/Math.max(1,y*.22),0,1):0;t.ambientOpacity.value=Ol(t.missedAppearances,f),t.renderedExcitation=n?l:Nl(t.renderedExcitation,l,c),t.excitation.value=t.renderedExcitation;let m=n?1:u,g=t.material.uniforms.uPresence;g&&(g.value=m),E[r].value=Math.max(m*.26,t.renderedExcitation*m)}),o.render(i,a),ee=window.requestAnimationFrame(P)},F=t=>{if(!(t instanceof PointerEvent))return!1;let n=e.getBoundingClientRect();return n.width<=0||n.height<=0?!1:t.clientX<n.left||t.clientX>n.right||t.clientY<n.top||t.clientY>n.bottom?(h.uPointerActive.value=0,!1):(h.uPointer.value.set((t.clientX-n.left)/n.width*2-1,-((t.clientY-n.top)/n.height*2-1)),h.uPointerActive.value=1,!0)},te=e=>{r||F(e)},ne=e=>{F(e)&&r&&(N=performance.now()/1e3+Bl)},re=()=>{h.uPointerActive.value=0},ie=t.revealCats?window:e.parentElement??e;ie.addEventListener(`pointermove`,te),ie.addEventListener(`pointerdown`,ne),ie.addEventListener(`pointerleave`,re),ie.addEventListener(`pointercancel`,re),ee=window.requestAnimationFrame(P);let I=!0,ae=!0,oe=()=>{let e=I&&ae;S||j===e||(j=e,h.uPointerActive.value=0,j?(M=0,ee=window.requestAnimationFrame(P)):window.cancelAnimationFrame(ee))},L=()=>{if(S)return;j=!1,S=!0,window.cancelAnimationFrame(ee),window.removeEventListener(`pagehide`,se),window.removeEventListener(`pageshow`,ce),ie.removeEventListener(`pointermove`,te),ie.removeEventListener(`pointerdown`,ne),ie.removeEventListener(`pointerleave`,re),ie.removeEventListener(`pointercancel`,re),A.disconnect();let e=new Set;C.forEach(t=>{i.remove(t.points),Object.values(t.geometries).forEach(t=>e.add(t)),t.material.dispose()}),e.forEach(e=>e.dispose()),m.dispose(),g.dispose(),o.dispose(),o.domElement.remove()},se=e=>{if(!e.persisted){L();return}ae=!1,oe()},ce=()=>{ae=!0,oe()};return window.addEventListener(`pagehide`,se),window.addEventListener(`pageshow`,ce),{setActive(e){I=e,oe()},cleanup:L}}function Hl(e){return e===`zh`?{verify:`验证器`,docs:`文档`,download:`下载`}:{verify:`VERIFIER`,docs:`DOCS`,download:`DOWNLOAD`}}function Ul(e){let t=Hl(e.locale),n=e=>e?` data-copy="${e}"`:``,r=e.verifyActive?` aria-current="page"`:``;return`
    <header class="landing-topbar" data-tapcam-topbar>
      <a class="landing-topbar__brand" href="${e.homeHref}" aria-label="TAPCam home">
        <img src="${e.assetBase}launch_logo.png" alt="" width="34" height="34" />
        <strong data-nav-brand-text>TAPCam</strong>
      </a>
      <nav class="landing-topbar__nav" aria-label="${e.navAriaLabel}" data-top-navigation>
        <a class="landing-topbar__link landing-topbar__link--download" href="https://testflight.apple.com/join/bwcgjzNd" target="_blank" rel="noopener noreferrer" data-nav-download${n(e.copyKeys?.download)}>${t.download}</a>
        <a class="landing-topbar__link landing-topbar__link--verify" href="${e.verifyHref}" data-nav-tool${r}${n(e.copyKeys?.verify)}>${t.verify}</a>
        <a class="landing-topbar__link landing-topbar__link--docs" href="https://github.com/TAP-NAP/TAPCamVerifier#verification-flow" target="_blank" rel="noopener noreferrer" data-nav-doc${n(e.copyKeys?.docs)}>${t.docs}</a>
        ...
        <button class="landing-topbar__lang" type="button" data-language-toggle data-nav-lang data-locale="${e.locale}" aria-label="${e.locale===`zh`?`Switch to English`:`切换到中文`}">
          <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  `}var Wl=`modulepreload`,Gl=function(e,t){return new URL(e,t).href},Kl={},ql=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Gl(t,n),t in Kl)return;Kl[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Wl,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};export{yi as A,ur as B,$i as C,ti as D,Ta as E,Xi as F,J as H,Ua as I,t as L,Fr as M,Fe as N,zi as O,An as P,Bi as R,Ir as S,xn as T,Wt as U,q as V,ta as _,ll as a,wt as b,Tr as c,ji as d,Li as f,oi as g,mi as h,Vl as i,Tt as j,wi as k,Z as l,Ri as m,Hl as n,Ai as o,Sn as p,Ul as r,lr as s,ql as t,Wa as u,vi as v,Qi as w,Jr as x,e as y,Vi as z};