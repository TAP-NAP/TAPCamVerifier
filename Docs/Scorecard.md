...
| Test coverage | 8.3 | Rust unit tests cover slot parsing, synthetic content binding, and the real fixture. TypeScript typecheck, production build, and a manual Chrome upload verification are part of the gate. Browser drag/drop automation is frozen unless explicitly reopened. |
...
4. Add a server-boundary diagnostic only: if the server echoes
...
5. Define a shared WASM module contract before adding research-only geometry or
