...
| Documentation readability | 8.8 | README, Mermaid flow, scoped verifier rule, parallel analysis/verification flow, fixture policy, scorecard, and AITrace now describe the v2 still-photo and v3 Live Photo hard-binding flow. |
