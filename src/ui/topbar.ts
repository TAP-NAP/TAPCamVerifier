  ...
  return `
    <header class="landing-topbar" data-tapcam-topbar>
      ...
      <nav class="landing-topbar__nav" aria-label="${options.navAriaLabel}" data-top-navigation>
        ...
        <a class="landing-topbar__link landing-topbar__link--docs" href="https://github.com/TAP-NAP/TAPCamVerifier#verification-flow" target="_blank" rel="noopener noreferrer" data-nav-doc${copyAttribute(options.copyKeys?.docs)}>${labels.docs}</a>
